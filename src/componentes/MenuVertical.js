    ...
    return(
        <div class="list-group" id="list-tab" role="tab-list">
            ...
            <div>
                ...
                <a type="button" href="" class="list-group-item list-group-item-action" aria-current="true">Gestionar datos personales</a>
                <a type="button" href={"/home/"+params.id+"/gestionarDatosClub"} class={params.opcion == 'gestionarDatosClub' ? 'list-group-item list-group-item-action active' : 'list-group-item list-group-item-action'} aria-current="true">Gestionar datos del club</a>
