...
function InfoPartido(props){
    ...
    useEffect(() => {
        axios.get("http://localhost:8080/getPartidoById?idPartido="+props.idPartido)
            .then(response => {
                setPartido(response.data); 
            })

        axios.get("http://localhost:8080/getGolesPartido?idPartido="+props.idPartido)
            .then(response => {
                setGoles(response.data);
            })

        axios.get("http://localhost:8080/getFaltasPartido?idPartido="+props.idPartido)
        .then(response => {
            ...
            <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Info partido</h5>
